...
\end{equation}
Now, since \corr{$-\partial_t k^\epl(t, s) \leq -\partial_t k^\epl(t, t)$ This is wrong for $\beta > 1$!!!!} for all $0 \leq s \leq t$ and in view of Remark \ref{rem:kernDeriv}, we can write
\begin{equation}
