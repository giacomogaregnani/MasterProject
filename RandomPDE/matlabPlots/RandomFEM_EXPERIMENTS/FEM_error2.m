function [errorL2, errL2Loc] = FEM_error2(uh, MESH, DATA, FE_SPACE, t)
...
switch MESH.dim
    ...
    case 2
        ...
        elseif nargout == 2
            ...
            errL2Loc = (((uhq-uq).^2)*FE_SPACE.quad_weights').*MESH.jac';
            errorL2  = sum(errL2Loc);
