...
% 3) advection b given by vector [b1;b2;b3]
% 4) exact solution u(x) defined in ex_adv_diff_reac1_3D.m
...
b1 = 1; b2 = 0.5; b3 = 0;
vp.b = scal_advection*[b1;b2;b3];

vp.f = @(x,k) -(vp.a.*ex_adv_diff_reac1_3D(x,[2,0,0])...
                + vp.a.*ex_adv_diff_reac1_3D(x,[0,2,0])...
                + vp.a.*ex_adv_diff_reac1_3D(x,[0,0,2]))...
              + vp.b(1).*ex_adv_diff_reac1_3D(x,[1 0 0])...
              + vp.b(2).*ex_adv_diff_reac1_3D(x,[0 1 0])...
              + vp.b(3).*ex_adv_diff_reac1_3D(x,[0 0 1]);
...
for i=1:Nmax
    ...
    [h1(i), l2(i), h1s(i), dg(i)] = ...
        get_DGerror_adv_diff_exact(mesh{i}, femspace{i}, vps{i}, eqn{i}, sol{i}, @ex_adv_diff_reac1_3D);
