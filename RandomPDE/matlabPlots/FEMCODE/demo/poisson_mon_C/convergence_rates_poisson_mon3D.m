...
%% WARNING, THIS TEST TAKES ~3 MINUTES
clear vp sol;

%% DEFINE DATA
vp.A = @operator_mon3d; % operator
vp.dxiA = @operator_jac_mon3d; % Jacobi of operator
vp.f = @rhs_mon3d;
...
for i=1:Nmax
    ...
    [h1(i,j), l2(i,j), h1s(i,j)] = ...
        get_H1error_exact(mesh{i,j}, femspace{i,j}, sol{i,j}, @ex3_mon);
