...
int main(int argc, char* argv[])
{
    ...
    sdeHomo.diffusion = &homoDiffusion;
    ...
    std::vector<double> epsTestSet = {0.1};
    ...
    // Signal ratio
    std::vector<unsigned int> ratioVec = {25, 50, 100};
    ...
    for (auto const &it : epsTestSet) {
        ...
        for (auto const &ratio : ratioVec) {
            ...
            posterior = std::make_shared<PFPosterior>(x, T, IC, ratio, noise, sdeHomo, param(0), M);
